#!/usr/bin/env node
/**
 * Auto-update checker for SuperKiro NPM package
...
const PACKAGE_NAME = '@bifrost_inc/superkiro';
...
function showUpdateBanner(currentVersion, latestVersion, autoUpdate = false) {
  ...
  return autoUpdate || process.env.SUPERKIRO_AUTO_UPDATE === 'true';
}
...
function performUpdate() {
  const updateCmd = getUpdateCommand();
  console.log('\x1b[36m🔄 Updating SuperKiro...\x1b[0m');
